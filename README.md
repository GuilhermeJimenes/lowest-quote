...
Api feita em python e flask para mostrar o uso de web scraping


## 🚀 Começando

Esse projeto usa selenium para buscar dados de site terceiros e analisar a cotação segundo o Banco 
central e com isso informar a moeda com menor cotação com base no dolar
...
* [Selenium](https://selenium-python.readthedocs.io/index.html) - Ferramenta para web scraping
